...
public class ManufacturersAdapter extends RecyclerView.Adapter<ManufacturersAdapter.ManufacturersViewHolder> {
    ...
    public ManufacturersAdapter(final List<ManufacturerModel> mList) {
        this.mList = mList;
    }
